defmodule Cinegraph.Metrics.PersonQualityScore do
  ...
  def calculate_person_score(person_id) do
    try do
      ...
      if Enum.empty?(person_movies) do
        ...
        {festival_nominations, direct_nominations} =
          count_festival_nominations_with_breakdown(person_id)
        ...
        # Bonus for direct wins
        # Bonus for direct nominations
        raw_score =
          canonical_count * @canonical_weight +
            high_rated_count * @high_rated_weight +
            total_count * @volume_weight +
            festival_wins * @festival_win_weight +
            direct_wins * @festival_win_weight +
            festival_nominations * @festival_nom_weight +
            direct_nominations * @festival_nom_weight
  ...
  def store_person_score(person_id, score, components \\ %{}) do
    ...
    |> Repo.insert(
      on_conflict:
        {:replace, [:score, :components, :metadata, :calculated_at, :valid_until, :updated_at]},
