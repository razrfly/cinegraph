defmodule Cinegraph.Imports.ImportStats do
  ...
  @update_interval 5_000 # Update stats every 5 seconds
  ...
  def init(_) do
    ...
    # Initialize stats
    :ets.insert(@table_name, {:current_stats, %{
      movies_per_minute: 0.0,
      active_jobs: %{},
      last_update: nil,
      last_movie_count: 0,
  ...
  defp update_import_stats do
    ...
    movies_per_minute = if time_diff > 0 do
