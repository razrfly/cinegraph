defmodule Mix.Tasks.Cinegraph.Prod.Health do
  @moduledoc """
  Read `/admin/health`'s verdict from production via `kamal app exec`
  (#739 Phase C). No DB pull required — calls
  `Cinegraph.Health.Facade.compute_full_verdict/0` inside the running prod
  container and pretty-prints the result locally.
