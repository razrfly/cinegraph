defmodule CinegraphWeb.MovieLive.ShowV2 do
  ...
  def render(assigns) do
            ...
            <div :if={@directors != []} class="mt-5">
              ...
              <div class="flex flex-wrap gap-x-3 gap-y-1">
                <a
                  ...
                  class="text-white hover:text-blue-300 font-medium text-[15px]"
                >
                  {d.person.name}
                </a>
              </div>
    ...
    <main class="mx-auto w-full max-w-2xl px-6 md:max-w-3xl lg:max-w-7xl lg:px-10 py-12 lg:py-16 space-y-12 lg:space-y-16">
      <%!-- CRI SCORE PANEL --%>
      <section>
      ...
      <%!-- MORE FROM DIRECTOR --%>
      <section :if={@director_other_films != [] && @directors != []}>
        <h2 class="font-display italic text-[28px] sm:text-[32px] tracking-[-.01em] text-mist-950 mb-6">
