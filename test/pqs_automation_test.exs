defmodule Cinegraph.PQSAutomationTest do
  ...
  defp test_monitoring_functions do
    ...
    try do
      ...
      assert_map_with_keys(metrics, ["total_people", "eligible_people", "people_with_pqs"], "Coverage metrics")
    rescue
    ...
    try do
      ...
      assert_map_with_keys(metrics, ["total_scores", "fresh_scores", "stale_scores"], "Freshness metrics")
    rescue
    ...
    try do
      ...
      assert_map_with_keys(metrics, ["total_jobs_24h", "successful_jobs_24h", "failure_rate_percent"], "Performance metrics")
    rescue
    ...
    try do
      ...
      assert_map_with_keys(indicators, ["overall_status", "coverage_healthy", "freshness_healthy"], "Health indicators")
    rescue
