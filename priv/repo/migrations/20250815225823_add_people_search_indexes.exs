defmodule Cinegraph.Repo.Migrations.AddPeopleSearchIndexes do
  ...
  def change do
    ...
    create_if_not_exists index(:people, ["LOWER(name) varchar_pattern_ops"],
                           name: :people_name_lower_pattern_idx
                         )
    ...
    create_if_not_exists index(:movie_credits, [:person_id, :movie_id, :job],
                           name: :movie_credits_person_movie_job_idx
                         )
  end
end
