defmodule Cinegraph.Repo.Migrations.CreateUnifiedFestivalTables do
  ...
  def change do
    ...
    create table(:festival_ceremonies) do
      add :organization_id, references(:festival_organizations, on_delete: :delete_all), null: false
    ...
    create table(:festival_categories) do
      ...
      add :category_type, :string # 'film', 'person', 'technical', 'special'
      add :metadata, :map, default: %{}
    ...
    create table(:festival_nominations) do
      ...
      add :prize_name, :string # e.g., "Palme d'Or", "Golden Lion", "Golden Bear"
    ...
    create constraint(:festival_nominations, :must_have_nominee,
