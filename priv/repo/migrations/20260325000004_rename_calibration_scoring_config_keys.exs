defmodule Cinegraph.Repo.Migrations.RenameCalibrationScoringConfigKeys do
  ...
  def up do
    ...
    SET category_weights = (
      category_weights
      - 'popular_opinion' - 'ivory_tower' - 'industry_recognition' - 'financial_performance'
    ...
    SET missing_data_strategies = (
      ...
      || jsonb_strip_nulls(jsonb_build_object(
           ...
           'critics',              missing_data_strategies->'ivory_tower',
  ...
  def down do
    ...
    SET category_weights = (
      category_weights
      - 'mob' - 'critics' - 'festival_recognition' - 'box_office' - 'time_machine' - 'auteurs'
      || jsonb_strip_nulls(jsonb_build_object(
    ...
    WHERE category_weights ?| ARRAY['mob','critics','festival_recognition','box_office','time_machine','auteurs']
    """)
    ...
    SET missing_data_strategies = (
      ...
      || jsonb_strip_nulls(jsonb_build_object(
           ...
           'ivory_tower',          missing_data_strategies->'critics',
    ...
    WHERE missing_data_strategies ?| ARRAY['mob','critics','festival_recognition','box_office','time_machine','auteurs']
    """)
  end
end
