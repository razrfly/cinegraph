defmodule Cinegraph.Repo.Migrations.AddCollaborationTables do
  ...
  def change do
    ...
    create table(:collaboration_details) do
      ...
      add :collaboration_type, :string, null: false # 'actor-actor', 'actor-director', etc.
    ...
    create unique_index(:collaboration_details, [:collaboration_id, :movie_id, :collaboration_type])
