      ...
      {:ok, %{"browserHtml" => html}} ->
        ...
        Enum.each(pagination_selectors, fn selector ->
          ...
          if length(elements) > 0 do
            IO.puts(
              "  Sample HTML: #{elements |> List.first() |> Floki.raw_html() |> String.slice(0..200)}"
            )
          end
        end)
        ...
        load_more_buttons =
          Enum.filter(buttons, fn button ->
            ...
            String.contains?(text, "more") || String.contains?(text, "load") ||
        ...
        count_indicators =
          ...
          |> Enum.filter(fn element ->
            ...
            String.contains?(text, "250") || String.contains?(text, "1,260") ||
              String.contains?(text, "1260")
          end)
          |> Enum.take(5)
        ...
        desc_elements =
          Floki.find(document, ".list-description, .lister-description, .ipc-html-content")
